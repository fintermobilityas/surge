...
std::string_view error_to_string(ErrorCode code) noexcept {
    ...
    case ErrorCode::InvalidManifest:  return "Invalid manifest";
    ...
    case ErrorCode::DecompressionErr: return "Decompression error";
    case ErrorCode::DiffError:        return "Binary diff error";
    case ErrorCode::PatchError:       return "Binary patch error";
    case ErrorCode::LockFailed:       return "Lock acquisition failed";
    case ErrorCode::LockConflict:     return "Lock conflict";
    case ErrorCode::SupervisorError:  return "Supervisor error";
    case ErrorCode::VersionError:     return "Version error";
    case ErrorCode::AlreadyUpToDate:  return "Already up to date";
    }
...
ErrorCode from_surge_result(int32_t result) noexcept {
    ...
    case -1: return ErrorCode::Unknown;
    case -2: return ErrorCode::Cancelled;
    case -3: return ErrorCode::NotFound;
    default: return static_cast<ErrorCode>(result);
    }
}
